...
import ecodualLogo from "@/assets/ecodual-logo.jpeg";
import allswipeLogo from "@/assets/allswipe-logo.jpg";
...
const Startups = () => {
  const startups = [
    ...
    { name: "Ecodual", logo: ecodualLogo, isImage: true },
    { name: "ALL-SWIPE", logo: allswipeLogo, isImage: true },
  ];
